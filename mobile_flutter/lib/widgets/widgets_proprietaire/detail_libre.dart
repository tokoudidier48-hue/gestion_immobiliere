...
// ─── Titre de section (ex: "DESCRIPTION", "CARACTÉRISTIQUES") ────────────────
...
// ─── Item de statut (Disponible / Avec prépayé) ───────────────────────────────
...
// ─── Ligne caractéristique (label ↔ valeur) ───────────────────────────────────

class CaracRow extends StatelessWidget {
  final String label;
  final String value;

  const CaracRow({super.key, required this.label, required this.value});
...
// ─── Carte section générique (fond blanc + padding) ───────────────────────────
