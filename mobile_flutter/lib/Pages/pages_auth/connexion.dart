      ...
      switch (result) {
        ...
        case GoogleLoginResult.error:
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(auth.error ?? 'Erreur connexion Google'),
                        ...
                        if (success) {
                          if (context.mounted) {
                            ...
                            if (role == "locataire") {
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(builder: (_) => AccueilLocatairePage()),
                              );

                            } else if (role == "proprietaire") {
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(builder: (_) => HomePageProprietaire()),
                              );
                      ...
                      builder: (context, auth, child) {
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Image.asset('assets/images/logo_google.png', width: 20),
                          ),
                        );
                      },
                    ),
