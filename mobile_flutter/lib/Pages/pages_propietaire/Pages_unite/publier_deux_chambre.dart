...
class PublierDeuxChambresSalonPage extends StatefulWidget {
  final int proprieteId;
  const PublierDeuxChambresSalonPage({super.key, required this.proprieteId});

  @override
  State<PublierDeuxChambresSalonPage> createState() => _PublierDeuxChambresSalonPageState();
}

class _PublierDeuxChambresSalonPageState extends State<PublierDeuxChambresSalonPage> {
  ...
  String? _typeDouche;
  String? _typeCaution;
  String? _typeUnite = 'deux_chambres_ordinaire';
  bool _prepaye = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Publier 2 Chambres Salon',
          ...
          TextButton(
            onPressed: () {
              ...
              setState(() {
                _typeDouche = null;
                _typeCaution = null;
                _typeUnite = 'deux_chambres_ordinaire';
                _prepaye = false;
                _images.clear();
              });
            },
          ...
          children: [
            ...
            _sectionCard(
              children: [
                ...
                _inputField(controller: _nomController, hint: 'Ex: 2 Chambres Salon N°1'),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Décrivez les deux chambres salon...',
                  ...
                  child: ElevatedButton(
                    onPressed: provider.isLoading ? null : () async {
                      final unite = Unites(
                        ...
                        typeUnite: _typeUnite ?? 'deux_chambres_ordinaire',
                    ...
                    child: provider.isLoading
                        ...
                        : const Text('Publier 2 Chambres Salon',
