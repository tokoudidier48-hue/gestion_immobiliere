...
class PublierEntreeCoucherPage extends StatefulWidget {
  final int proprieteId;
  const PublierEntreeCoucherPage({super.key, required this.proprieteId});

  @override
  State<PublierEntreeCoucherPage> createState() => _PublierEntreeCoucherPageState();
}

class _PublierEntreeCoucherPageState extends State<PublierEntreeCoucherPage> {
  ...
  String? _typeDouche;
  String? _typeCaution;
  String? _typeUnite = 'entree_coucher_ordinaire';
  bool _prepaye = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Publier Entrée Coucher',
          ...
          TextButton(
            onPressed: () {
              ...
              setState(() {
                _typeDouche = null;
                _typeCaution = null;
                _typeUnite = 'entree_coucher_ordinaire';
                _prepaye = false;
                _images.clear();
              });
            },
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _sectionCard(
              children: [
                _sectionLabel('NOM DE L\'UNITÉ'),
                const SizedBox(height: 8),
                _inputField(controller: _nomController, hint: 'Ex: Entrée coucher N°1'),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Décrivez l\'entrée coucher...',
                  ...
                  child: ElevatedButton(
                    onPressed: provider.isLoading ? null : () async {
                      final unite = Unites(
                        ...
                        typeUnite: _typeUnite ?? 'entree_coucher_ordinaire',
                      ...
                      if (provider.error != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text("Entrée coucher publiée avec succès !")),
                        );
                    ...
                    child: provider.isLoading
                        ...
                        : const Text('Publier l\'entrée coucher',
