        ...
        background: Stack(
          ...
          children: [
            ...
            Container(
              ...
              child: const Center(
                child: Icon(Icons.park, size: 80, color: Color(0xFF22C55E)),
              ),
            ),
            // Badges superposés
            Positioned(
              ...
              child: Row(
                children: const [
                  TopBadge(label: 'CHAMBRE SALON SANITAIRE', color: kBadgeChambre),
                  SizedBox(width: 8),
                  TopBadge(label: 'LIBRE', color: kLibreGreen),
                ],
              ),
            ),
          ],
    ...
    return SectionCard(
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 12),
          CaracRow(label: 'Douche', value: 'Interne'),
        ],
      ),
    );
  }
    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          ...
          const CaracRow(label: "Nombre d'avance", value: '3 Mois'),
